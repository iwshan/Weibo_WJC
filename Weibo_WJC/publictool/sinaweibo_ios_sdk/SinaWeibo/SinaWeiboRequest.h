...
@class SinaWeibo;
typedef void (^ SWRequestBlock)(SinaWeiboRequest * request,id obj);
typedef void(^ SWFinishBlock)(NSMutableArray * arrData);
...
@interface SinaWeiboRequest : NSObject
{
    ...
    SWRequestBlock  resultBlock;
    SWRequestBlock  failBlock;
    SWRequestBlock  responseBlock;
    SWRequestBlock  rawDataBlock;
    SWFinishBlock  finishBlock;
...
-(NSArray*)setMicroblogType:(NSArray *)arrData;
