...
{
    [didLogInBlock release];
    didLogInBlock = [block copy];
}
-(void)setDidLogOutBlock:(SinaWeiboBaiscBlock)block
{
    [didLogOutBlock release];
    didLogOutBlock = [block copy];
}
-(void)setLogInDidCancelBlock:(SinaWeiboBaiscBlock)block
{
    [logInDidCancelBlock release];
    logInDidCancelBlock = [block copy];
}
-(void)setlogInDidFailBlock:(SinaWeiboErrorBlock)block
{
    [logInDidFailBlock release];
    logInDidFailBlock = [block copy];
}
-(void)setAccessTokenInvalidOrExpiredBlock:(SinaWeiboErrorBlock)block
{
    [accessTokenInvalidOrExpiredBlock release];
    accessTokenInvalidOrExpiredBlock = [block copy];
}
@end
